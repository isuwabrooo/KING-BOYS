...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to KING BOYS voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel KING BOYS özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'KING BOYS yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'KING BOYS yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'KING BOYS, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'KING BOYS, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional KING BOYS features. Turn your account into a ai chatbot!'
    already_on = 'KING BOYS artificial intelligence is already fully functional.'
    already_off = 'KING BOYS artificial intelligence is currently running semi-functional.'
    succ_on = 'KING BOYS Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'KING BOYS Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
