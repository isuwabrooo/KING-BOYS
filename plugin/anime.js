...
if (Config.WORKTYPE == 'private') {
    ...
    King.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*Made By KING BOYS*'})

    }));
}
else if (Config.WORKTYPE == 'public') {

    King.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
